...
void loop() {
  ...
  if (ET.receiveData()) {
    ...
    price = ((int)((mydata.before * 10) + mydata.after)) / 10.0;


    Serial.println(mydata.before);
    Serial.println(mydata.after);
    Serial.println(price);
    Serial.println((int)((mydata.before * 10) + mydata.after));

    messagebuff = "KC7IBT,KC7IBT,:" + price;
    prepMessage();
  }
